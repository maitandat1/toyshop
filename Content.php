     ...
     <div class="slider-area">
			...
			<div class="block-slider block-slider4">
				<ul class="" id="bxslider-home4">
					<li>
						<img src="img/R.jpg" width="100" height="50" alt="Slide">
					...
					<li><img src="img/maval.jpg" alt="Slide">
						<div class="caption-group">
							<h2 class="">
							</h2>
							<h4 class=""></h4>
                    ...
                    <li><img src="img/maz.jpg" alt="Slide">
						<div class="caption-group">
							<h2 class="">
							</h2>
							<h4 class=""></h4>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="latest-product">
                        <h2 class="section-title">HOT PRODUCTS AND ON SALE</h2>
