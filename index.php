...
<!--datatable-->
  ...
  ?>
   ...
   <header id="header"><!--header-->
		...
		<div class="header-middle" style="background-color:grey"><!--header-middle-->
			<div class="container" >
				<div>
					<div class="col-sm-6" >
						<div class="logo pull-left" >
                            <a href="index.php" style="background-color:grey;color:white">ATN STORE
                            <h5 class="">WWW.ATNSORE.COM.VN</h5>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav" >
                                <li><a href="?page=cart" style="background-color:grey;color:black">
                                ...
                                ?>
                                <li><a href="?page=update_customer" style="background-color:grey;color:black">
                                <i class="fa fa-lock"></i>Hi, <?php echo $_SESSION['us'] ?></a></li>
                                <li><a href="?page=logout" style="background-color:grey;color:black">
                                <i class="fa fa-crosshairs"></i>Log Out</a></li>
                                <?php 
                                    }
                                    else{
                                ?>
                                <li><a href="?page=login" style="background-color:grey;color:black">
                                <i class="fa fa-lock"></i>Login</a></li>
                                <li><a href="?page=register" style="background-color:grey;color:black">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    ...
                    <h2 class="">ATN STORE</h2>
                        <p>ATN is one of the toy stores that grows quickly and steadily regardless of favorable or difficult economic situations. ATN store chain was established in 2023, specializing in retailing toy products for children over 13 years old.
Talking about ATN is talking about one of the fastest growing and most stable toy stores in the world. The chain of stores was established in the developing years of 2010. We hope the store will help you have a wonderful experience for our children. Best regards!</p>
                        <div class="footer-social">
                            <a href="https://www.facebook.com/profile.php?id=100045200885671&mibextid=9R9pXO" target="_blank"><i class="fa fa-facebook"></i></a>
